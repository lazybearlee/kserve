...
func (in *Batcher) DeepCopyInto(out *Batcher) {
	*out = *in
	...
	if in.EnableAdaptive != nil {
		in, out := &in.EnableAdaptive, &out.EnableAdaptive
		*out = new(bool)
		**out = **in
	}
	if in.MinBatchSize != nil {
		in, out := &in.MinBatchSize, &out.MinBatchSize
		*out = new(int)
		**out = **in
	}
	if in.MinLatency != nil {
		in, out := &in.MinLatency, &out.MinLatency
		*out = new(int)
		**out = **in
	}
	...
	if in.TargetLatencyPercentile != nil {
		in, out := &in.TargetLatencyPercentile, &out.TargetLatencyPercentile
		*out = new(string)
		**out = **in
	}
	if in.QueueLengthBasedIncreaseThreshold != nil {
		in, out := &in.QueueLengthBasedIncreaseThreshold, &out.QueueLengthBasedIncreaseThreshold
		*out = new(string)
		**out = **in
	}
	if in.StateTransitionCooldown != nil {
		in, out := &in.StateTransitionCooldown, &out.StateTransitionCooldown
		*out = new(int)
		**out = **in
	}
}
